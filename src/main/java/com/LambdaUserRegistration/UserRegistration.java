package com.LambdaUserRegistration;
...
import java.util.regex.Pattern;
	...
	public class UserRegistration {
	    ...
	    public boolean validateFirstName(String fname, String firstname) throws UserRegistrationException {
	        return patternChecker(firstname, NAME_PATTERN);
	    }

	    public boolean validateLastName(String lName, String lastName) throws UserRegistrationException {
